...
export function AddnewTaskModal({ todoId }: { todoId: string }) {
  ...
  return (
    <>
      <button
        ...
        className="w-full justify-between h-9 rounded-md px-2 flex items-center bg-add text-white text-sm pulse"
      >
        Add Task
        <Plus className="w-5" />
      </button>
